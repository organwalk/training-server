...
import com.training.client.UserClient;
import com.training.entity.HeadersAuthInfo;
import com.training.utils.FilterUtil;
...
public class AuthenticationFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // 获取本次请求的URL路径的权限标识
        String reqAuthMark = reqURL.substring(4, 7);
