...
public interface LikeMapper {
    ...
    @Select("select COUNT(id) from t_learn_like where comment_id=#{comment_id} and reply_id=#{reply_id} and state=1")
    Integer getReplyLikeCountByComIDAndReplyId(@Param("comment_id")int comment_id,@Param("reply_id")int reply_id);
